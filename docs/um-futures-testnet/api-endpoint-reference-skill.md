<!-- Source: Binance Skills Hub skill 'derivatives-trading-usds-futures' (official hub repo github.com/binance/binance-skills-hub does not yet list this skill; mirrored from raw.githubusercontent.com/NeverSight/skills_feed/refs/heads/main/data/skills-md/binance/binance-skills-hub/derivatives-trading-usds-futures/SKILL.md)
     Fetched: 2026-09-25 -->
---

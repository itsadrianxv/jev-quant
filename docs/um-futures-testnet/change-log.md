...
- `GET /fapi/v1/tradingSchedule` (Trading Schedule) and the Trading Session Stream now cover the FX
  market (`FX` / `FXUpdate`), with session types "REGULAR" and "NO_TRADING".
